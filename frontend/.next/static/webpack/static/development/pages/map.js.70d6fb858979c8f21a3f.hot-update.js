...
var fadein = Object(styled_components__WEBPACK_IMPORTED_MODULE_0__["keyframes"])(["0%{transform:scale(0,0)}60%{transform:scale(1.1,1.1)}80%{transform:scale(0.9,0.9)}100%{transform:scale(1,1)}"]);
...
})(["box-sizing:content-box;width:50%;position:absolute;z-index:1;padding:1%;bottom:40px;right:0;transform:translateX(100vw);transition:all 0.5s;opacity:0;background:rgba(0,0,0,0.4);margin-right:5%;", ""], function (_ref) {
  var opened = _ref.opened;
  return opened && "transform: translateX(0vw); opacity: 1;";
});
...
})(["color:#fff;position:absolute;z-index:1;font-size:3em;bottom:40px;right:90px;cursor:pointer;transition:all 0.5s;z-index:2;transform:scale(", ");&:hover{transform:scale(1.2,1.2);}i{animation:", " 0.6s ease-out;}"], function (_ref2) {
  var size = _ref2.size;
...
//# sourceMappingURL=map.js.70d6fb858979c8f21a3f.hot-update.js.map