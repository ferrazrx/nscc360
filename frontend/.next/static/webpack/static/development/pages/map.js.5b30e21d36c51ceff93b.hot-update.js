...
var fadein = Object(styled_components__WEBPACK_IMPORTED_MODULE_0__["keyframes"])(["from{transform:scale(0,0) rotate:{10deg}}to{transform:scale(1,1)rotate:{19deg}}"]);
...
})(["width:50%;position:absolute;z-index:1;padding:1%;bottom:0;right:0;transform:translateX(100%);transition:all 1s;opacity:0;background:rgba(0,0,0,0.4);", ""], function (_ref) {
...
})(["color:#fff;position:absolute;z-index:1;font-size:3em;bottom:40px;right:40px;cursor:pointer;transition:all 0.5s;z-index:2;transform:scale(", ");&:hover{transform:scale(1.2,1.2);}i{animation:", " 0.6s ease-in;}"], function (_ref2) {
  var size = _ref2.size;
...
//# sourceMappingURL=map.js.5b30e21d36c51ceff93b.hot-update.js.map