...
})(["width:50%;position:absolute;z-index:1;padding:1%;bottom:0;right:0;transform:translateX(100%);transition:all 1s;opacity:0;", ""], function (_ref) {
...
})(["color:#fff;position:absolute;z-index:1;font-size:3em;bottom:40px;right:40px;cursor:pointer;transition:all 0.5s;z-index:2;transform:scale(", ");&:hover{transform:scale(1.2,1.2);}"], function (_ref2) {
  var size = _ref2.size;
...
})(["color:#fff;position:absolute;z-index:1;font-size:3em;top:50%;left:10px;cursor:pointer;transition:all 0.5s;z-index:2;transform:translateY(-50%) scale(", ");&:hover{transform:scale(1.2,1.2);}"], function (_ref3) {
  var size = _ref3.size;
  return size ? "0.6,0.6" : "1,1";
});
...
//# sourceMappingURL=map.js.377f95672ea786a69fea.hot-update.js.map