...
})(["display:flex;justify-content:space-around;font-size:2em;font-weight:800;font-family:\"Oswald\",sans-serif;.dropdown{cursor:pointer;flex:1;text-align:center;}.dropdown-menu{width:100%;text-align:center;}.dropdown-item:hover{color:#fff;}"]);
...
})(["position:absolute;z-index:9999;background:#fff;padding:5px;top:50%;opacity:0;left:0;transform:translateY(-50%) translateX(-100%);", ""], function (_ref) {
...
})(["width:50%;position:absolute;z-index:1;padding:1%;bottom:0;right:0;transform:translateX(100%);transition:all 1s;opacity:0;transition:all 0.5s;", ""], function (_ref2) {
...
//# sourceMappingURL=map.js.ffb795cb55342305b80a.hot-update.js.map