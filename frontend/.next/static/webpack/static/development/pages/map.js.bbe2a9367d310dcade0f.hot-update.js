...
})(["height:100%;display:flex;flex-direction:row;justify-content:space-around;font-size:2em;font-weight:800;font-family:\"Oswald\",sans-serif;.dropdown{cursor:pointer;flex:1;text-align:center;}.dropdown-menu{width:100%;text-align:center;}.dropdown-item:hover{color:#fff;}"]);
...
})(["position:absolute;z-index:9999;background:#fff;padding:5px;height:30vh;top:50%;opacity:0;left:0;transform:translateY(-50%) translateX(-100%);", ""], function (_ref) {
...
//# sourceMappingURL=map.js.bbe2a9367d310dcade0f.hot-update.js.map