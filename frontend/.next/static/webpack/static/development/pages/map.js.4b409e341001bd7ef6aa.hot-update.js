...
})(["width:800px;position:absolute;z-index:1;background:#fff;padding:1%;bottom:0;right:0;transform:translateX(100%);transition:all 1s;", ""], function (_ref) {
  var opened = _ref.opened;
  return opened && "transform: translateX(0%);";
});
...
})(["font-size:3em;position:absolute;z-index:1;padding:1%;margin:1%;bottom:0;right:0;cursor:pointer;transition:all 0.5s;z-index:2;color:", ";&:hover{transform:scale(1.2,1.2);}"], function (_ref2) {
  var color = _ref2.color;
  return color ? "#000" : "#FFF";
});
...
//# sourceMappingURL=map.js.4b409e341001bd7ef6aa.hot-update.js.map