...
var BannerContainer = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].div.withConfig({
  displayName: "style__BannerContainer",
  componentId: "chklh3-0"
})([".content{color:#FFF;padding:50px 0;h1{font-family:'Oswald',sans-serif;text-align:center;font-weight:900;font-size:4em;}h2:nth-of-type(1){text-align:center;font-weight:100;font-family:'Open Sans',sans-serif;font-size:3.2em;}h2:nth-of-type(2){text-align:center;font-weight:500;font-family:'Open Sans',sans-serif;}.line{background:#FFF;width:60px;height:2px;display:inline-block;margin:10px 30px;}.button{display:block;margin:0 auto;width:150px;transition:0.4s all;}.button:hover{cursor:pointer;transform:scale(1.2,1.2)}}"]);


/***/ })

})
//# sourceMappingURL=index.js.9ac92374afeba8b1cf0e.hot-update.js.map