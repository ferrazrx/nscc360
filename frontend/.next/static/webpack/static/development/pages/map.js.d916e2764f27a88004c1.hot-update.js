...
})(["color:#fff;position:absolute;z-index:1;font-size:3em;top:50%;left:0;cursor:pointer;transition:all 0.5s;z-index:2;transform:translateY(-50%) scale(", ");&:hover{transform:scale(1.2,1.2);}"], function (_ref3) {
  var size = _ref3.size;
  return size ? "0.6,0.6" : "1,1";
});
...
//# sourceMappingURL=map.js.d916e2764f27a88004c1.hot-update.js.map